 ...
 ?>
    <div class="container col-md-10 col-sm-12 col-lg-9 rounded-0 d-flex justify-content-between">
        <div class="col-md-8 col-sm-12" style="max-width:93vw">
            ...
            showError('post_img');
            if(count($posts)<1){
                echo "<p style='width:100%' class='p-2 bg-white border rounded text-center my-3 col-12'>Follow a Group, Someone or Add a new post</p>";
            }
...
if(count($follow_suggestions)<1){
    echo "<p class='p-2 bg-white border rounded text-center'>No Suggestions For You</p>";
            ...
            <!-- Groups Suggessiton -->
            <div>
            <h6 class="text-muted p-2">Clubs Follow Suggestions</h6>
...
<promptly-app-embed published-app-id="30863422-e453-4dae-ba4f-2747d55c3e96" chat-bubble="true"></promptly-app-embed>
